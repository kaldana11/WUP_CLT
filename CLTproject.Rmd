...
This code creates a density plot for 1000 rows of temperature data, each calculated from a sample of 16 data points. The standard deviation is now a quarter of what it was which is 10.31 and we expected `r sd(my1000$k4)`.
...
The standard deviation is now one fifth of what it was in the beginning we got 8 and we expected`r sd(my1000$k5)` and it is only off by a little bit. Our hypothesis was incorrect but not as far along as we thought. This graph portrays a mean of 49.9924.
